...
namespace ST10439397_PROG6221_Part_1
{
    internal class UserQuestions
    {
        ...
        public static void Replies(string username, string[] messages)
        {
            ...
            string[] Howareyouanswers = new string[] { "Sorry I'm not programmed with or opinions, but I am functioning properly, thank you.", 
                                                       "All systems are go, feeling secure and ready to assist!", 
                                                        "I'm doing great. Let's talk cybersecurity!" };

            string[] Whatisyourpupose = new string[] { "what is your purpose", "what is your purpose?", "purpose" };
            string[] Whatisyourpuposeanswers = new string[] { $"My purpose is to help you stay safe online {username}, by providing information and answering your questions about cybersecurity.",
                                                            $"My goal is to raise awareness about online threats and help you avoid them {username}.", 
                                                            $"I'm here to assist you {username} in learning how to protect your digital life." };

            string[] WhatcanIaskyouabout = new string[] { "what can I ask you about?", "what can I ask you about", "what can i ask" };

            //Seniment and keyword arrays for detecting user sentiment and keywords.
            ...
            // Check if the question contains any of the keywords or sentiments.
